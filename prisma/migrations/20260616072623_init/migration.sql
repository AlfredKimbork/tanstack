...
-- AddForeignKey
ALTER TABLE `Cart` ADD CONSTRAINT `Cart_prevUserId_fkey` FOREIGN KEY (`prevUserId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
